...
| -------- | ------------- | -------------- | ------------------- | ------------------------- |
| Starter  | $27 (~NIO 989) | up to 6         | $5/user (7-10)      | 10 → Growth               |
| Growth   | $90           | up to 24       | $4/user (25-35)     | 35 → Business             |
| Business | $150          | up to 50       | negotiate beyond 50 | —                         |

Per-user cost decreases as tiers grow (~$4.50 → $3.75 → $3.00 avg/user) — standard SaaS volume discount, matches how Alegra/Holded both scale. Actual price points still need validation against ALUVAL's willingness to pay — anchor is time/error savings over free-but-legacy SEM, not feature count.

**Competitiveness check against comps:**

| Tier | Marco (price, $/user) | Closest comp | Comp ($/user) | Read |
|---|---|---|---|---|
| Starter | $27, $4.50/user (6 seats) | Alegra Plus $50, $6.25/user (8 seats) | LatAm floor | Cheaper per-seat and ~46% cheaper in absolute price than the top LatAm-market comp |
| Starter | $27, $4.50/user | Holded Basic ~$31, $15.50/user (2 seats) | Spain, feature-match | Cheaper absolute price with 3x the included seats |
