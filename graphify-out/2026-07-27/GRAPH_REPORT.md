...
## Corpus Check
- 54 files · ~8,740 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 310 nodes · 412 edges · 31 communities (21 shown, 10 thin omitted)
- Extraction: 94% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f70311cb`
...
Cohesion: 0.10
Nodes (25): Bills / Expenses, Cafeteria El Molino VI, Community Security (cash), David - School Tuition (monthly), ECSA Uno Los Robles, Electricity Bill, Fritoni, Home Internet Bill (+17 more)

### Community 2 - "Debts, Loans & Credit Cards"
Cohesion: 0.11
Nodes (26): AVANZ, Links, BAC (Banco de America Central), Links, Ficohsa, Links, Lafise (Lafise Bancentro), Links (+18 more)
...
Cohesion: 0.07
Nodes (23): Aluval, CRM, Links, Clients, Engagement History, In All Media (Coderfull SA), Links, Payment Terms (+15 more)
...
## Knowledge Gaps
- **129 isolated node(s):** `alwaysUpdateLinks`, `enableCommunityPlugins`, `Bill`, `CRM`, `Links` (+124 more)
...
- **What is the exact relationship between `Credit Cards.md` and `David - School Tuition (monthly)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Finance Overview` connect `In All Media Client` to `Marco ERP & SEM Projects`, `Income, Clients & July Bills`, `Debts, Loans & Credit Cards`, `Bill Inbox Template`?**
...
- **Why does `In All Media` connect `Marco ERP & SEM Projects` to `Resume & Skills`, `Pluto TV Org & Contacts`, `In All Media Client`?**
