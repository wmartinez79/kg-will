# Graph Report - kg-will  (2026-07-27)

## Corpus Check
- 55 files · ~9,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 313 nodes · 414 edges · 31 communities (20 shown, 11 thin omitted)
- Extraction: 94% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a0d0a1d5`
...
Cohesion: 0.05
Nodes (44): Bills / Expenses, Cafeteria El Molino VI, Community Security (cash), David - School Tuition (monthly), ECSA Uno Los Robles, Electricity Bill, Fritoni, Home Internet Bill (+36 more)

### Community 2 - "Debts, Loans & Credit Cards"
Cohesion: 0.10
Nodes (30): AVANZ, Links, BAC (Banco de America Central), Links, Ficohsa, Links, Lafise (Lafise Bancentro), Links (+22 more)

### Community 3 - "Marco ERP & SEM Projects"
Cohesion: 0.09
Nodes (31): Aluval, Enhancement Payment System, CRM, Links, Vidrieria F. Morales, Architecture, Backend ([[Marco ERP - Backend|marco-backend]]), Backend Modules (`api/src/domain/`) (+23 more)
...
Cohesion: 0.22
Nodes (8): Current Payment Plan (as of 2026-07-26), Debt Payoff Analysis, Key takeaways, Method, Payoff order, Rates used, Reuse notes, Review against tier strategy
...
## Knowledge Gaps
- **130 isolated node(s):** `alwaysUpdateLinks`, `enableCommunityPlugins`, `Bill`, `CRM`, `Links` (+125 more)
...
- **What is the exact relationship between `Credit Cards.md` and `David - School Tuition (monthly)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Finance Overview` connect `Income, Clients & July Bills` to `Marco ERP & SEM Projects`, `Debts, Loans & Credit Cards`, `Bill Inbox Template`?**
...
- **Why does `In All Media` connect `Marco ERP & SEM Projects` to `Resume & Skills`, `Income, Clients & July Bills`, `Pluto TV Org & Contacts`?**
